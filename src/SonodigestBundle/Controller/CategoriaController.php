...
use SonodigestBundle\Entity\Categoria;
use SonodigestBundle\Form\CategoriaType;
...
class CategoriaController extends Controller
{
     ...
     * @Method("POST")
     * @Template("SonodigestBundle:Categoria:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SonodigestBundle:Categoria')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SonodigestBundle:Categoria:edit.html.twig")
     */
