...
use SonodigestBundle\Entity\Categoriablog;
use SonodigestBundle\Form\CategoriablogType;
...
class CategoriablogController extends Controller
{
     ...
     * @Method("POST")
     * @Template("SonodigestBundle:categoriablog:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SonodigestBundle:categoriablog:edit.html.twig")
     */
