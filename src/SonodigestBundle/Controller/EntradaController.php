...
use SonodigestBundle\Entity\Entrada;
use SonodigestBundle\Form\EntradaType;
...
class EntradaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SonodigestBundle:Entrada')->findAll();
     ...
     * @Method("POST")
     * @Template("SonodigestBundle:Entrada:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if($entity->getIdimagen()->getFile()!=null){
                    ...
                    $entity->getIdimagen()->setImagen1($nombreArchivo);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SonodigestBundle:Entrada')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SonodigestBundle:Entrada:edit.html.twig")
     */
