...
use SonodigestBundle\Entity\Persona;
use SonodigestBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SonodigestBundle:Persona')->findAll();
     ...
     * @Method("POST")
     * @Template("SonodigestBundle:Persona:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SonodigestBundle:Persona')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SonodigestBundle:Persona:edit.html.twig")
     */
