...
use SonodigestBundle\Entity\Rol;
use SonodigestBundle\Form\RolType;
...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SonodigestBundle:Rol')->findAll();
     ...
     * @Method("POST")
     * @Template("SonodigestBundle:Rol:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SonodigestBundle:Rol')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SonodigestBundle:Rol:edit.html.twig")
     */
