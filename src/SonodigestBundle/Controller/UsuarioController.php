...
use SonodigestBundle\Entity\Usuario;
use SonodigestBundle\Form\UsuarioType;
...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SonodigestBundle:Usuario')->findAll();
     ...
     * @Method("POST")
     * @Template("SonodigestBundle:Usuario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SonodigestBundle:Usuario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SonodigestBundle:Usuario:edit.html.twig")
     */
